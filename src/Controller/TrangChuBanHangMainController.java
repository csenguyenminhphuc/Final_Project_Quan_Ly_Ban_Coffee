...
public class TrangChuBanHangMainController implements ActionListener, MouseListener {
	private TrangChuBanHangMainGUI view;
	
	public TrangChuBanHangMainController(View.TrangChuBanHangMainGUI view) {
		this.view = view;
		initController();
	}
