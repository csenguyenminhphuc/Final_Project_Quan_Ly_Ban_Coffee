...
public class TrangChuQuanLyGUI extends JPanel {
	...
	// Danh sách listener để thông báo thay đổi
	private List<FileChangeListener> listeners = new ArrayList<>();

	public TrangChuQuanLyGUI() {
		prefs = Preferences.userNodeForPackage(TrangChuQuanLyGUI.class);
		initComponents();
		autoLoadLastFile();
	}
	...
	public void saveCurrentFilePath() {
		if (currentFilePath != null && !currentFilePath.isEmpty()) {
			...
			notifyFileChanged(currentFilePath);
	...
	/**
	 * Thêm listener để lắng nghe thay đổi file
	 */
	...
	/**
	 * Thông báo cho tất cả listener khi file thay đổi
	 */
	...
	/**
	 * Thông báo cho tất cả listener khi file bị xóa
	 */
	private void notifyFileCleared() {
		for (FileChangeListener listener : listeners) {
